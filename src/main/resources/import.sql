insert into user values(101,'New York' ,'jcoggins@example.com', 'Joe', 'Coggins', 'admin', 'ssn101', 'jcoggins');
insert into user values(102, 'Los Angeles' ,'bshwartz@example.com', 'Bill', 'Shwartz', 'admin', 'ssn102', 'bshwartz');
insert into user values(103, 'Chicago' ,'junderwood@example.com', 'John', 'Underwood', 'admin', 'ssn103', 'junderwood');
