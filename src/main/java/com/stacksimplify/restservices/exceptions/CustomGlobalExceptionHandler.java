...
// AOP code Globally affects all controllers
@ControllerAdvice
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		CustomErrorDetails customErrorDetails = new CustomErrorDetails(
				new Date(), "From MethodArgumentNotValid Exception in GEH",
				ex.getMessage() );
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
		...
		CustomErrorDetails customErrorDetails = new CustomErrorDetails(
				new Date(), "From HttpRequestMethodNotSupported Exception in GEH"
						+ " - Method not allowed",
				ex.getMessage() );
